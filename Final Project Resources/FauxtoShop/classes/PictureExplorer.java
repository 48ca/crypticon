 ...
 */
   ...
   */
   ...
   //rg added 	
      ...
      /**
      *Read up on stacks and how to use them.  
      *Instantiate a stack of Digital Pictures as a private 
      *field.  Before the user makes a change to the picture, 
      *make a copy of the current picture and push it. The Undo 
      *button simply pops the previous picture and displays that.  
      *If you pop an empty stack then Java generates an error 
