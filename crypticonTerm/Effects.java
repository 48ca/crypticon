...
{   
  ...
  ****************************************************************/
   ...
   /*
      public static BufferedImage Flip(BufferedImage img, int h, int w, String c1, String c2)
   {
      ...
      for(int y=0; y<h; y++)
      {
         for(int x=0; x<w; x++)
         {
            ...
            Color tintColor = c;
			int iC = 0;
			switch(c1.toLowerCase())
			{
				case "g":
					if(c2.equals("g"))
						return img;
					if(c2.equals("r"))
						tintColor = new Color(c.getGreen(),c.getRed(),c.getBlue());
					if(c2.equals("b"))
						tintColor = new Color(c.getRed(),c.getBlue(),c.getGreen());
					break;
					//this isn't done but you know something to do vvvvvvvvvvvvvvvvvvv
				case "r":
					if(c2.equals("g"))
						tintColor = new Color(c.getGreen(),c.getRed(),c.getBlue());
					if(c2.equals("r"))
