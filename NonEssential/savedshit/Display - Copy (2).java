...
public class Display
{
	...
	public static BufferedImage imageEffectsNoEncoding;
	...
	public static JLabel initImageLabel(BufferedImage image)
	{
		...
		//if(height>width) scaler = 1060.0/height;
   ...
   public static String fnSave()
   {
	...
	{
		JOptionPane.showMessageDialog(null,"Your message is approximately "+over+" characters too long.\nYou must shorten your message or choose a larger image.","Error!",JOptionPane.ERROR_MESSAGE);
	}
